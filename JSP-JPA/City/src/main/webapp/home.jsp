...
<head>
    <title>Ciudades Patrimonio de la Humanidad</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body>
    <div class="container p-0 shadow">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavId">
                    <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                        <li class="nav-item">
                            <a class="h4 text-white" href="Controller?operacion=ciudades">Ciudades</a>
                        </li>
                        <li class="nav-item dropdown ms-lg-5">
                            <a class="h4 dropdown-toggle text-white" href="#" id="dropdownId" data-bs-toggle="dropdown"
        ...
        <c:if test="${ciudades!=null}">
            <div class="row justify-content-center mt-3">
            	<c:forEach items="${ciudades}" var="ciudad" >
	                <div class="col-lg-6 col-md-6 position-relative mb-3 d-flex">
	        ...
	        <h1 class="text-center my-5 bg-primary text-white">${ciudad}</h1>
		                ...
		                <div class="card flex-fill position-relative pb-5">
		                    ...
		                    <div class="card-body">
		                        ...
		                        <p>
                                    ...
                                    <c:forEach items="${ruta.puntos}" var="punto">
                                            <c:set var="suma" value="${suma+punto.puntos}"/>
                                    </c:forEach>
                                    <c:set var="media" value="${suma/ruta.puntos.size()}"/>
                                    <p>${media}</p>
        ...
        <footer class="bg-primary text-white p-3">
            <h5 class="text-center">&copy; Ciudades Patrimonio</h5>
        </footer>
    </div>
